...
<div class="card">
    <div class="card-header border-bottom-0">
        <h3 class="card-title text-bold" style="font-size:1.4rem">Update Unit</h3>
    ...
    <div class="card-body">
        <form action="{{ route('admin.units.update', $unit->id) }}" method="POST">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('singular_name') ?? $unit->singular_name }}"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('plural_name') ?? $unit->plural_name }}"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('singular_abbr') ?? $unit->singular_abbr }}"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('plural_abbr') ?? $unit->plural_abbr }}"
            ...
            <div class="mt-4 mb-1">
                <input type="submit" class="btn btn-primary" value="Update Unit">
